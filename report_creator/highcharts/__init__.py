...
from report_creator.highcharts.base import true, false, null, DictObject
from report_creator.highcharts.options import get_highchart_data
import html
...
def HTMLEntitiesToUnicode(text):
    ...
    """
    # text = force_text(BeautifulStoneSoup(text, convertEntities=BeautifulStoneSoup.ALL_ENTITIES))
    text = force_text(BeautifulSoup(text,features= "xml"))
    return text
...
class HighchartRender(object):
    ...
    def options(self):
        ...
        import json
        #str_json= unicode(self.model)
        json = force_text(self.model)
        #print("Here is end!")
