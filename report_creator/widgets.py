...
class RangeWidget(forms.MultiWidget):
    ...
    def format_output(self, rendered_widgets):
        ...
        return render_to_string('report_creator/widgets/range_widget.html', widget_context)
    ...
    def render(self, name, value, attrs, renderer):
        ...
        return self._render('report_creator/widgets/range_widget.html', context, renderer)
